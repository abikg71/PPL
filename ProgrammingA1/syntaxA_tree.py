...
def parse(input, grammar, actions, gotos):
    ...
    while True:
        ...
        if action[0] == 's':
            ...
            # TODO #2: create a new tree, set data to token, and append it
        ...
        # reduce operation
            ...
            # TODO #4: get "len(rhs)" trees from the right of the list of trees
            # and add each of them as child of the new tree you created,
            #preserving the left-right order
