...
-- TODO #3
-- name: getNCols
-- description: given a board, return its number of columns or 0 if rows do not
...
-- TODO #4
-- name: getBox
-- description: given a board and box coordinates, return the correspondent
-- box as a sequence
...
-- TODO #5
-- name: getEmptySpot
-- description: given a board, return the first location that is empty
-- (i.e., it has zero), if one exists; OK to assume that you will only call
-- this function when you know that there is an empty spot
-- input: a board
...
-- TODO #6
-- name: isGridValid
-- description: given a board, return True/False depending whether the given
-- board constitutes a valid grid (i.e., #rows = #cols = 9) or not
-- input: a board
-- output: True/False
...
-- description: return True/False depending whether the given sequence is valid
--  or not, according to sudoku rules
...
-- hint: build a list with the digits from the given sequence that are
...
-- TODO #8
-- name: areRowsValid
-- description: return True/False depending whether ALL of the row sequences
-- are valid or not
...
-- TODO #9
-- name: areColsValid
-- description: return True/False depending whether ALL of the col sequences
--  are valid or not
...
-- TODO #10
-- name: areBoxesValid
-- description: return True/False depending whether ALL of the box sequences
--  are valid or not
...
-- TODO #11
-- name: isValid
-- description: return True/False depending whether the given board is valid
-- sudoku configuration or not
-- input: a board
-- output: True/False
...
-- TODO #12
-- name: isCompleted
-- description: return True/False depending whether the given board is
-- completed or not; a board is considered completed if there isn't a
--  single empty cell
-- input: a board
-- output: True/False
...
-- TODO #13
-- name: isSolved
-- description: return True/False depending whether the given board is solved
...
-- TODO #14
-- name: setRowAt
-- description: given a sequence, an index, and a value, writes the value at
--  the index location, returning a new sequence, but only if the original
--  value at the specified location is empty; otherwise, return the original
--  sequence unchanged
...
-- TODO #15
-- name: setBoardAt
-- description: given a board, two indexes i and j (representing coordinates),
--  and a value, writes the value at the (i, j) coordinate, returning the
-- new board, but only if the original value at the specified location is empty;
...
-- TODO #16
-- name: buildChoices
-- description: given a board and a two indexes i and j
-- (representing coordinates), generate ALL possible boards, replacing the cell
--  at (i, j) with ALL possible digits from 1 to 9; OK to assume that the
-- cell at (i, j) is empty
...
-- ends or invalid intermediate solutions are listed as empty boards)
-- input: a board
-- output: a list of boards from the original board
